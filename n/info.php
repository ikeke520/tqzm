...
if(empty($thisnews)) {
	header("Location:" .check_dir($config['web_url'])."n/");
	exit;
}
$mysql_class->update("news", "hit=hit+1", array("id"=>$thisnews['id']));
?>
<!DOCTYPE html>
<html lang="zh">
<head>
...
<title><?php echo $thisnews['title'];?>__<?php echo $config['seo_title'];?></title>
