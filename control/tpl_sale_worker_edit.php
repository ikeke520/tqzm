...
if($_GET['update'] == "true") {
	...
	$mysql_class->update("worker", $data, array("id"=>$thisworker['id']));
	adminlog("修改业务员：".trim($thisworker['id']));
...
<head>
<meta charset="utf-8">
<title>编辑业务员__后台管理中心__<?php echo $config['seo_title'];?></title>
            ...
            <div class="tabcard">
                <div class="menu">
                    <ul>
                        ...
                        <li class="on"><a href="javascript:">编辑业务员</a></li>
                        <div class="clear"></div>
                    </ul>
                </div>
            </div>
        </div>
		<form action="./?ac=sale&do=worker&step=edit&update=true&id=<?php echo $thisworker['id'];?>&sid=<?php echo SID;?>" method="post" onSubmit="return check_form();">
			<input type="hidden" name="uid" value="<?php echo $thisworker['uid'];?>">
			<table class="form" >
				<tr>
					<td height="40" align="right"><span class="red">*</span>业务员姓名：</td>
					<td>
						<input type="text" class="input" name="realname" value="<?php echo $thisworker['realname'];?>">
				...
				<tr>
					...
					<td>
                        <input type="text" class="input" name="idno" value="<?php echo $thisworker['idno'];?>">
				...
				<tr>
					...
					<td>
						<div class="teacher_preview">
							<img src="<?php echo $mysql_class->get_field_value("users", "headimgurl", array("id"=>$thisworker['uid']));?>" />
				...
				<tr>
					...
					<td>
						<input type="text" class="input" name="phone" value="<?php echo $thisworker['phone'];?>">
				...
				<tr>
					...
					<td>
						<textarea class="textarea" name="address" style="width:400px; height:50px;"><?php echo $thisworker['address'];?></textarea>
					</td>
				</tr>
				<tr>
