...
<head>
<meta charset="utf-8">
<title>修改管理员__后台管理中心__<?php echo $config['seo_title'];?></title>
	...
	<div class="mainright">
		<div class="tab">
			<ul>
				...
				<li class="on">修改管理员</li>
				<div class="clear"></div>
			</ul>
		</div>
		<form action="./?ac=setting&do=admin&step=edited&id=<?php echo $thisadmin['id'];?>&sid=<?php echo SID;?>" method="post" onSubmit="return check_form();">
			<table class="form" >
				<tr>
					<td height="40" align="right"><span class="red">*</span>管理员名称：</td>
					<td>
						<input type="text" class="input" name="name" value="<?php echo $thisadmin['name'];?>">
