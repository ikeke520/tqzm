...
if($_GET['insert'] == "true") {
	...
	$mysql_class->insert("activity", $data);
	$thisid = $mysql_class->insert_id();
	if($_POST['tag']) {
		foreach($_POST['tag'] as $tmp) {
			$thistag = $mysql_class->select_one("tag", "*", array("id"=>$tmp));
			if($thistag) {
				$mysql_class->insert("tag_list", array("tid"=>$thistag['id'], "tname"=>add_slashes($thistag['name']), "aid"=>$thisid));
			}
		}
		$mysql_class->query("UPDATE {$config['db_prefix']}tag SET child_num = (SELECT COUNT(*) FROM {$config['db_prefix']}tag_list WHERE tid={$config['db_prefix']}tag.id) WHERE id IN ('".implode("','", array_map("intval", $_POST['tag']))."')");
	}
		adminlog("添加活动：".$thisid);
...
<head>
<meta charset="utf-8">
<title>新增活动__后台管理中心__<?php echo $config['seo_title'];?></title>
...
<div class="main">
	<div class="position">您的位置：<a href="../" target="_blank"><?php echo $config['seo_title'];?></a>&nbsp;&raquo;&nbsp;<a href="./">后台管理中心</a>&nbsp;&raquo;&nbsp;<a href="./?ac=index">活动管理</a>&nbsp;&raquo;&nbsp;添加活动</div>
	<div class="mainright">
		<div class="tab">
			<ul>
				<li><a href="./?ac=index">活动列表</a></li>
				<li class="on"><a href="./?ac=index&do=add">新增活动</a></li>
		...
		<div class="mt10">
            <div class="tabcard">
                <div class="menu">
                    <ul>
                        <li class="on"><a href="./?ac=index&do=add">基本信息</a></li>
						<li><a href="javascript:">活动图片</a></li>
                        <div class="clear"></div>
                    </ul>
                </div>
            </div>
        </div>
		<form action="./?ac=index&do=add&insert=true&sid=<?php echo SID;?>" method="post" onSubmit="return check_form();">
			<table class="form" >
				<tr>
					<td height="60" align="right"><span class="red">*</span>活动主题：</td>
					<td>
						<textarea class="textarea" name="title" style="width:400px; height:50px;"></textarea>
					</td>
				</tr>
				<tr>
...
?>
				...
				<tr>
					...
					<td>
						<input type="number" name="person_num" style="width:100px;" class="input" value="0">&nbsp;&nbsp;<span class="gray">报名人数达到设定的人数后则不能继续报名，0表示不限制</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="year_duration" class="input">&nbsp;&nbsp;<span class="gray">年龄要求，如1岁以内等</span>
					</td>
				</tr>
				<tr>
					<td height="40" align="right"><span class="red">*</span>活动场地：</td>
					<td>
						<input type="text" name="activity_type" class="input">&nbsp;&nbsp;<span class="gray">室内、室外、草地、森林等</span>
					</td>
				</tr>
				<tr>
					<td height="40" align="right"><span class="red">*</span>参加费用：</td>
					<td>
						<input type="text" name="price" style="width:100px;" class="input" value="0">&nbsp;&nbsp;<span class="gray">单次购买活动的价格，0表示免费</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="date" style="width:150px;" class="input">&nbsp;&nbsp;<span class="gray">务必填写好日期，注意时间格式</span>
					</td>
				</tr>
				<tr>
					<td height="40" align="right"><span class="red">*</span>活动时间：</td>
					<td>
						<input type="text" name="timestr" style="width:150px;" class="input">&nbsp;&nbsp;<span class="gray">格式随意，如星期天下午3:00</span>
					</td>
				</tr>
				<tr>
					<td height="40" align="right"><span class="red">*</span>活动人气：</td>
					<td>
						<input type="text" name="hit" style="width:150px;" class="input">&nbsp;&nbsp;<span class="gray">活动点击数</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<textarea class="textarea" name="navurl" style="width:400px; height:50px;"></textarea>
					</td>
				</tr>
				<tr>
					<td height="60" align="right">报名须知：</td>
					<td>
						<textarea class="textarea" name="notice" style="width:650px; height:100px;"></textarea>
					</td>
				</tr>
				<tr>
					<td height="40" align="right"><span class="red">*</span>活动详情：</td>
					<td>
						<script id="intro" name="intro" type="text/plain" style="width:650px;height:300px;"></script>
					</td>
				</tr>
				<tr>
